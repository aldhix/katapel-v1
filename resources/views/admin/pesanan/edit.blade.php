...
@section('content')
<h1 class="h2 border-bottom pt-3 pb-3">Pesanan</h1>
...
<div class="row">
	...
	<div class="col-md-8">
		...
		<p>
			...
			action="{{ route('pesanan.update',['pesanan'=>$row->id]) }}" > 
		...
		<hr>
		<p>
			Nama : <strong>{{ $row->nama_pelanggan }}</strong>
		</p>
		<p>
			Nomor HP : {{ $row->no_hp_pelanggan }}
		</p>
		<p>
